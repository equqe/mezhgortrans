(function ($) {
    ...
    $(".mode").on("click", function () {
        ...
        if (localStorage.getItem('body_mode')) localStorage.removeItem('body_mode');
            else localStorage.setItem('body_mode', 'dark-only');
    });
...
$(document).ready(function () {
    if (localStorage.getItem("body_mode")) {
        console.log(`mode: ${localStorage.getItem("body_mode")}`)
        $('body').addClass('dark-only');
        $('.mode i').removeClass('fa fa-moon-o').addClass('fa fa-lightbulb-o')
    }
